...
### Deprecated
- ⚠️ **This package is now deprecated and no longer maintained**
- Please migrate to [dart-llm](https://pub.dev/packages/dart_llm) instead: https://github.com/brynjen/dart-llm
- This package will remain available for existing projects but will not receive updates
