...
class LlamaBindings {
  ...
  void llama_attach_threadpool(
    ...
    ffi.Pointer<ggml_threadpool> threadpool_batch,
  ) {
  ...
  void llama_opt_epoch(
    ffi.Pointer<llama_context> lctx,
    ffi.Pointer<ggml_opt_dataset> dataset,
    ffi.Pointer<ggml_opt_result> result_train,
    ffi.Pointer<ggml_opt_result> result_eval,
    int idata_split,
    ffi.Pointer<
      ffi.NativeFunction<
        ffi.Void Function(
          ffi.Bool train,
          ffi.Pointer<ggml_opt_context> opt_ctx,
          ffi.Pointer<ggml_opt_dataset> dataset,
          ffi.Pointer<ggml_opt_result> result,
          ffi.Int64 ibatch,
  ...
  late final _llama_opt_epochPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Pointer<llama_context>,
            ffi.Pointer<ggml_opt_dataset>,
            ffi.Pointer<ggml_opt_result>,
            ffi.Pointer<ggml_opt_result>,
            ffi.Int64,
            ffi.Pointer<
              ffi.NativeFunction<
...
final class llama_model_tensor_buft_override extends ffi.Struct {
  ...
  external ffi.Pointer<ggml_backend_buffer_type> buft;
}

final class llama_model_params extends ffi.Struct {
  /// NULL-terminated list of devices to use for offloading (if NULL, all available devices are used)
  external ffi.Pointer<ffi.Pointer<ggml_backend_device>> devices;
